...
//    }
  ...
  public void myNewTest() {
    assertThat(
        updateFieldByPath(updateEmployeePath, "employee.name", "Anna", EmployeeModel.class)
            .getEmployee()
            .getName(),
        equalTo("Anna"));
    ...
    assertThat(
        updateFieldByPath(
                JSOnFileToString(updateEmployeePath), "employee.company.name", "SoftServe", EmployeeModel.class)
            .getEmployee()
            .getCompany()
            .getName(),
        equalTo("SoftServe"));
