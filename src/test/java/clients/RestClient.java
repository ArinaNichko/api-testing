...
public class RestClient {
    ...
    private Response sendRequestForHttpMethods(Method httpMethod, String url, Object requestBody, Map<String, String> params) {
        RequestSpecification requestSpecification = given().contentType(ContentType.JSON).body(ofNullable(requestBody).orElse(StringUtils.EMPTY)).queryParams(ofNullable(params).orElse(emptyMap()));
